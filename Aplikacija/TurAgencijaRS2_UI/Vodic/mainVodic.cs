...
{
    public partial class mainVodic : Form
    {
        #region konstruktor
        ...
        public mainVodic(int _korisnikId)
        ...
        private void mainVodic_MouseDown(object sender, MouseEventArgs e)
        {
            dragging = true;
            start_Point = new Point(e.X, e.Y);
        }

        private void mainVodic_MouseMove(object sender, MouseEventArgs e)
        {
            if (dragging)
            {
        ...
        private void mainVodic_MouseUp(object sender, MouseEventArgs e)
        {
            dragging = false;
        }
        ...
        private void IzmjenaLozinke_Click(object sender, EventArgs e)
        {
            ...
            izmjenaLozinke izmjenaLozinke = new izmjenaLozinke(korisnikId);
